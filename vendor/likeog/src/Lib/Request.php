...
use likeog\Docker\Factory\RequestInterface;
...
class Request implements RequestInterface
{
	 ...
	 * 
	 * @param  resource        $socket 当前的连接的Socket信息
	 * @param  responseObject  likeog\Docker\Factory\ResponseInterface
	 * @return responseObject  likeog\Docker\Factory\ResponseInterface
	 */
